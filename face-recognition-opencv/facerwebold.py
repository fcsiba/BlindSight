...
while True:
    ...
    path = '/Users/rehan/Documents/FYP/PROJECT/face-recognition-opencv/unknown'
    # Draw a rectangle around the faces
    if not os.path.exists('/Users/rehan/Documents/FYP/PROJECT/face-recognition-opencv/unknown'):
        os.makedirs('/Users/rehan/Documents/FYP/PROJECT/face-recognition-opencv/unknown')
   # print("what")
      ...
      #  print("fa")
        ...
        if not saving:
            ...
            if 'Unknown' in recognize_faces_image.names or recognize_faces_image.names==[]:
                ...
                temp_path = '/Users/rehan/Documents/FYP/PROJECT/face-recognition-opencv/profiles/'+name
                if not os.path.exists(temp_path):
                    os.makedirs(temp_path)
                else:
                    temp_len = len(os.listdir('/Users/rehan/Documents/FYP/PROJECT/face-recognition-opencv/profiles/'))
                    ...
                    temp_path = '/Users/rehan/Documents/FYP/PROJECT/face-recognition-opencv/profiles/'+name +str(temp_len)
